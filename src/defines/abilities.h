...
enum poke_abilities
{
		...
		ABILITY_PASTEL_VEIL,  // 0xE2
		ABILITY_HUNGER_SWITCH,  // 0xE3@
		ABILITY_QUICK_DRAW,  // 0xE4@
		ABILITY_UNSEEN_FIST, // 0xE5@
        ABILITY_FULL_METAL_BODY, //0xE6
        ABILITY_SHADOW_SHIELD, //0xE7
        ABILITY_PRISM_ARMOR, //0xE8
		ABILITY_NEUROFORCE, //0xE9
		ABILITY_GORILLA_TACTICS, //0xEA 
        ABILITY_NEUTRALIZING_GAS,  // 0xEB
        ABILITY_LIBERO, //0xEC
        ABILITY_BALL_FETCH, //0xED
        ABILITY_COTTON_DOWN, //0xEE@
        ABILITY_PROPELLER_TAIL, //0xEF
        ABILITY_MIRROR_ARMOR, //0xF0@
        ABILITY_GULP_MISSILE, //0xF1@
        ABILITY_STALWART, //0xF2
        ABILITY_STEAM_ENGINE, //0xF3
        ABILITY_PUNK_ROCK, //0xF4
        ABILITY_SAND_SPIT, //0xF5
        ABILITY_ICE_SCALES, //0xF6
        ABILITY_RIPEN, //0xF7@
        ABILITY_ICE_FACE, //0xF8@
        ABILITY_POWER_SPOT, //0xF9
        ABILITY_MIMICRY, //0xFA@
        ABILITY_SCREEN_ClEANER, //0xFB
        ABILITY_STEELY_SPIRIT, //0xFC
        ABILITY_PERISH_BODY, //0xFD
		ABILITY_WANDERING_SPIRIT, //0xFE
		ABILITY_NONAME, //0xFF
		ABILITY_NONE, //0x100	
        ABILITY_ELECTRIC_SURGE, //0x101 原0xE2
        ABILITY_PSYCHIC_SURGE, //0x102 原0xE3
        ABILITY_MISTY_SURGE, //0x103 原0xE4
        ABILITY_GRASSY_SURGE, //0x104 原0xE5
		ABILITY_INTREPID_SWORD, //0x105 原0xEA 
        ABILITY_DAUNTLESS_SHIELD //0x106 原0xEB
};
