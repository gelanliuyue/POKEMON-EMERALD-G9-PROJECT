...
{
	if (slot == 0)
    	return (last_used_ability = (*basestat_table)[species].abilities.a1);
	if (slot == 1)
    	return (last_used_ability = (*basestat_table)[species].abilities.a2);
	else
    	return (last_used_ability = (*basestat_table)[species].abilities.a3);
}
