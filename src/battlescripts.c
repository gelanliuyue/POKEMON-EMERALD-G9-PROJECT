...
const u16 sound_moves[] = {MOVE_BOOMBURST, MOVE_BUG_BUZZ, MOVE_CHATTER, MOVE_CLANGING_SCALES, MOVE_CONFIDE,
        ...
        MOVE_SING, MOVE_SNARL, MOVE_SNORE, MOVE_SPARKLING_ARIA, MOVE_SUPERSONIC, MOVE_UPROAR, MOVE_Z_KOMMO_O, MOVE_OVERDRIVE,
        MOVE_EERIE_SPELL, 0xFFFF};
const u16 powder_moves[] = {MOVE_COTTON_SPORE, MOVE_POISON_POWDER, MOVE_POWDER, /*MOVE_RAGE_POWDER,*/ MOVE_SLEEP_POWDER,
        MOVE_SPORE, MOVE_STUN_SPORE, MOVE_MAGIC_POWDER, 0xFFFF};
const u16 ball_bomb_moves[] = {MOVE_ACID_SPRAY, MOVE_AURA_SPHERE, MOVE_BARRAGE, MOVE_BEAK_BLAST, MOVE_BULLET_SEED, MOVE_EGG_BOMB,
        ...
        MOVE_SLUDGE_BOMB, MOVE_WEATHER_BALL, MOVE_ZAP_CANNON, MOVE_POLLEN_PUFF, MOVE_PYRO_BALL, 0xFFFF};
const u16 reckless_moves_table[] = {MOVE_BRAVE_BIRD, MOVE_DOUBLE_EDGE, MOVE_FLARE_BLITZ, MOVE_HEAD_CHARGE,
        MOVE_HEAD_SMASH, MOVE_HIGH_JUMP_KICK, MOVE_JUMP_KICK, MOVE_SUBMISSION, MOVE_TAKE_DOWN, MOVE_LIGHT_OF_RUIN,
        MOVE_VOLT_TACKLE, MOVE_WOOD_HAMMER, MOVE_WILD_CHARGE, MOVE_MIND_BLOWN, MOVE_STEEL_BEAM, MOVE_STRUGGLE, 0xFFFF};
const u16 ironfist_moves_table[] = {MOVE_BULLET_PUNCH, MOVE_COMET_PUNCH, MOVE_DIZZY_PUNCH, MOVE_DOUBLE_IRON_BASH, MOVE_DRAIN_PUNCH,
        ...
        MOVE_MEGA_PUNCH, MOVE_METEOR_MASH, MOVE_POWER_UP_PUNCH, MOVE_SHADOW_PUNCH, MOVE_SKY_UPPERCUT, MOVE_THUNDER_PUNCH,
...
const u16 sheerforce_moves_table[] = {MOVE_WATERFALL, MOVE_IRON_HEAD, MOVE_STOMP, MOVE_ZEN_HEADBUTT, MOVE_ROCK_CLIMB,
        ...
        MOVE_AIR_SLASH, MOVE_BITE, MOVE_CRUNCH, MOVE_ICE_PUNCH, MOVE_BULLDOZE, MOVE_POWER_UP_PUNCH, MOVE_IRON_TAIL,
        ...
        MOVE_MUD_BOMB, MOVE_LAVA_PLUME, MOVE_TWISTER, MOVE_SKY_ATTACK, MOVE_DRAGON_RUSH, MOVE_STEEL_WING, MOVE_MUD_SLAP,
        ...
        MOVE_DIZZY_PUNCH, MOVE_ELECTROWEB, MOVE_ENERGY_BALL, MOVE_FIERY_DANCE, MOVE_FREEZE_DRY, MOVE_FREEZE_SHOCK,
        ...
        MOVE_Z_ALOLAN_RAICHU, MOVE_SPLISHY_SPLASH, MOVE_FLOATY_FALL, MOVE_BUZZY_BLITZ, MOVE_SIZZLY_SLIDE, MOVE_GLITZY_GLOW, MOVE_BADDY_BAD,
        MOVE_JAW_LOCK, MOVE_DRUM_BEATING, MOVE_PYRO_BALL, MOVE_BREAKING_SWIPE, MOVE_APPLE_ACID,MOVE_DOUBLE_IRON_BASH,
        MOVE_GRAV_APPLE, MOVE_SPIRIT_BREAK, MOVE_STRANGE_STEAM, MOVE_SHELL_SIDE_ARM, MOVE_SHELL_SIDE_ARM_PHYSICS,
        MOVE_SKITTER_SMACK, MOVE_SCALE_SHOT, MOVE_BURNING_JEALOUSY, MOVE_SCORCHING_SANDS, MOVE_FREEZING_GLARE, MOVE_FIERY_WRATH,
        MOVE_THUNDEROUS_KICK, MOVE_EERIE_SPELL, 0xFFFF};
const u16 biting_moves_table[] = {MOVE_BITE, MOVE_CRUNCH, MOVE_POISON_FANG, MOVE_FIRE_FANG, MOVE_ICE_FANG,
        MOVE_THUNDER_FANG, MOVE_HYPER_FANG, MOVE_PSYCHIC_FANGS, MOVE_FISHIOUS_REND, 0xFFFF};
const u16 megalauncher_moves_table[] = {MOVE_WATER_PULSE, MOVE_DARK_PULSE, MOVE_AURA_SPHERE, MOVE_HEAL_PULSE,
        MOVE_DRAGON_PULSE, MOVE_ORIGIN_PULSE, MOVE_TERRAIN_PULSE, 0xFFFF};
const u16 moveshitting_onair[] = {MOVE_TWISTER, MOVE_SKY_UPPERCUT, MOVE_SONIC_BOOM, MOVE_GUST, MOVE_THUNDER,
        MOVE_HURRICANE, MOVE_SMACK_DOWN, MOVE_THOUSAND_ARROWS, 0xFFFF};
const u16 moveshitting_underground[] = {MOVE_MAGNITUDE, MOVE_EARTHQUAKE, MOVE_FISSURE, MOVE_SONIC_BOOM, 0xFFFF};
...
const u16 user_thawing_moves[] = {MOVE_FLAME_WHEEL, MOVE_SACRED_FIRE, MOVE_SCALD, MOVE_FLARE_BLITZ, MOVE_FUSION_FLARE,
        MOVE_STEAM_ERUPTION, MOVE_BURN_UP, MOVE_SIZZLY_SLIDE, MOVE_SCORCHING_SANDS, 0xFFFF};
const u16 ignore_targetstats_moves[] = {MOVE_SACRED_SWORD, MOVE_CHIP_AWAY, MOVE_DARKEST_LARIAT, 0xFFFF};
const u16 always_crit_hits[] = {MOVE_FROST_BREATH, MOVE_STORM_THROW, MOVE_Z_ASH_GRENINJA, MOVE_ZIPPY_ZAP, MOVE_WICKED_BLOW, MOVE_SURGING_STRIKES, 0xFFFF};
...
const u16 moves_with_charging_turn[] = {MOVE_BOUNCE, MOVE_DIG, MOVE_DIVE, MOVE_FLY, MOVE_FREEZE_SHOCK, MOVE_GEOMANCY,
        ...
        MOVE_SKY_DROP, MOVE_SOLAR_BEAM, MOVE_SOLAR_BLADE, MOVE_METEOR_BEAM, 0xFFFF};
...
const u16 pressing_moves_table[] = {MOVE_BODY_SLAM, MOVE_DRAGON_RUSH, MOVE_FLYING_PRESS, MOVE_HEAT_CRASH, MOVE_STEAMROLLER,
		MOVE_STOMP, MOVE_HEAVY_SLAM, MOVE_Z_INCINEROAR, MOVE_SHADOW_FORCE, MOVE_PHANTOM_FORCE, 0xFFFF};
...
const u16 twoturnstrings[] = {0x1F6, 0x57, 0x56, 0x55, 0x13E, 0x1F8, 0x1F9, 0x54, 0x1FA, 0x58, 0x59, 0x13D, 0x280};
...
const u16 bind_strings[] = {0x5A, 0x5B, 0x5C, 0x5D, 0x148, 0x17C, 0x17D,
        0x184,0x27f, 0x283}; //bind, whirlpool, wrap, clamp, sand tomb, fire spin, magma storm, infestation, Snap Trap,Thunder Cage
